    ...
    <>
      ...
      <div className="mainContractContainer">
        ...
        <p className="smartContactDetail">
          Everyone can check out our smart contract by clicking <a className="here" href='https://bscscan.com/address/0x6fe928971bfc1c6d2de8e60e28c9ec3e42ef16b0' target="_blank">here.</a> <br/> Or scan
          the QR from your device.
        </p>
        <div>
